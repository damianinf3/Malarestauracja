#include <iostream>
#include "Cukrzyk.h"//' oznacza szukaj l=pliku w folderze z projektu
#include <fstream>//korzystanie z pliku tekstowego
#include <cstdlib>//uzycie funkcji exit

using namespace std;

void Cukrzyk::wczytaj()
{
    fstream plik;
...
Cukrzyk::Cukrzyk(int nr, int odp){
