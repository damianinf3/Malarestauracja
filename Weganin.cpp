#include <iostream>
#include "Weganin.h"//' oznacza szukaj l=pliku w folderze z projektu
...
void Weganin::wczytaj()
{
    fstream plik;//wspolpraca z plikeim tekstowym zajecia 7 c++
        ...
        int nr_linii=(nr_dan)*15+1;//inna nazwa
        int aktualny_nr=1;
...
Weganin::Weganin(int nr, int odp){
